...
abstract class BaseGamePeer
{
    ...
    const GAME_PLATFORM_ID = 'net_bazzline_media_library_media_game.game_platform_id';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'MediaId', 'GamePlatformId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'mediaId', 'gamePlatformId', ),
        BasePeer::TYPE_COLNAME => array (GamePeer::ID, GamePeer::MEDIA_ID, GamePeer::GAME_PLATFORM_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'MEDIA_ID', 'GAME_PLATFORM_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'media_id', 'game_platform_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'MediaId' => 1, 'GamePlatformId' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'mediaId' => 1, 'gamePlatformId' => 2, ),
        BasePeer::TYPE_COLNAME => array (GamePeer::ID => 0, GamePeer::MEDIA_ID => 1, GamePeer::GAME_PLATFORM_ID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'MEDIA_ID' => 1, 'GAME_PLATFORM_ID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'media_id' => 1, 'game_platform_id' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GamePeer::GAME_PLATFORM_ID);
        } else {
    ...
    /**
     * Returns the number of rows matching criteria, joining the related GamePlatform table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinGamePlatform(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
        ...
        $criteria->addJoin(GamePeer::GAME_PLATFORM_ID, GamePlatformPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Game objects pre-filled with their GamePlatform objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Game objects.
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinGamePlatform(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = GamePlatformPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = GamePlatformPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    $obj2 = new $cls();
                    $obj2->hydrate($row, $startcol);
                    GamePlatformPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (Game) to $obj2 (GamePlatform)
                $obj2->addGame($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        GamePlatformPeer::addSelectColumns($criteria);
        $startcol4 = $startcol3 + GamePlatformPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined GamePlatform rows

            $key3 = GamePlatformPeer::getPrimaryKeyHashFromRow($row, $startcol3);
            if ($key3 !== null) {
                $obj3 = GamePlatformPeer::getInstanceFromPool($key3);
                if (!$obj3) {
                    ...
                    GamePlatformPeer::addInstanceToPool($obj3, $key3);
                } // if obj3 loaded

                // Add the $obj1 (Game) to the collection in $obj3 (GamePlatform)
                $obj3->addGame($obj1);
            } // if joined row not null
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptGamePlatform(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
    ...
    public static function doSelectJoinAllExceptMedia(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        GamePlatformPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + GamePlatformPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = GamePeer::getInstanceFromPool($key1))) {
                ...
                $key2 = GamePlatformPeer::getPrimaryKeyHashFromRow($row, $startcol2);
                if ($key2 !== null) {
                    $obj2 = GamePlatformPeer::getInstanceFromPool($key2);
                    if (!$obj2) {
                ...
                // Add the $obj1 (Game) to the collection in $obj2 (GamePlatform)
                $obj2->addGame($obj1);
    ...
    /**
     * Selects a collection of Game objects pre-filled with all related objects except GamePlatform.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptGamePlatform(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
