...
abstract class BaseGame extends BaseObject implements Persistent
{
    ...
    public function setGamePlatformId($v)
    {
        ...
        if ($this->game_platform_id !== $v) {
            ...
            $this->modifiedColumns[] = GamePeer::GAME_PLATFORM_ID;
        }

        if ($this->aGamePlatform !== null && $this->aGamePlatform->getId() !== $v) {
            $this->aGamePlatform = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->game_platform_id = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aGamePlatform !== null && $this->game_platform_id !== $this->aGamePlatform->getId()) {
            $this->aGamePlatform = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aGamePlatform !== null) {
                if ($this->aGamePlatform->isModified() || $this->aGamePlatform->isNew()) {
                    $affectedRows += $this->aGamePlatform->save($con);
                }
                $this->setGamePlatform($this->aGamePlatform);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GamePeer::GAME_PLATFORM_ID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'game_platform_id':
                        $stmt->bindValue($identifier, $this->game_platform_id, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aGamePlatform !== null) {
                if (!$this->aGamePlatform->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aGamePlatform->getValidationFailures());
                }
            }
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aGamePlatform) {
                $result['GamePlatform'] = $this->aGamePlatform->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setGamePlatformId($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GamePeer::GAME_PLATFORM_ID)) $criteria->add(GamePeer::GAME_PLATFORM_ID, $this->game_platform_id);
    ...
    /**
     * Declares an association between this object and a GamePlatform object.
     *
     * @param                  GamePlatform $v
     * @return Game The current object (for fluent API support)
     * @throws PropelException
     */
    public function setGamePlatform(GamePlatform $v = null)
    {
        if ($v === null) {
        ...
        $this->aGamePlatform = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the GamePlatform object, it will not be re-added.
        if ($v !== null) {
            $v->addGame($this);
        }
    ...
    /**
     * Get the associated GamePlatform object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return GamePlatform The associated GamePlatform object.
     * @throws PropelException
     */
    public function getGamePlatform(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aGamePlatform === null && (($this->game_platform_id !== "" && $this->game_platform_id !== null)) && $doQuery) {
            $this->aGamePlatform = GamePlatformQuery::create()->findPk($this->game_platform_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aGamePlatform->addGames($this);
             */
        }

        return $this->aGamePlatform;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aGamePlatform instanceof Persistent) {
              $this->aGamePlatform->clearAllReferences($deep);
            }
