...
class MediaToGenreTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'net-bazzline-media-library.map.MediaToGenreTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\MediaToGenre');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Genre', 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\Genre', RelationMap::MANY_TO_ONE, array('media_genre_id' => 'id', ), null, null);
    } // buildRelations()
