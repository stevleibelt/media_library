...
abstract class BaseUserQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'netBazzlineMediaLibrary', $modelName = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\User\\User', $modelAlias = null)
    {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Net\Bazzline\MediaLibrary\Model\Database\User\IdentityQuery A secondary query class using the current class as primary query
     */
    public function useIdentityQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinIdentity($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Identity', '\Net\Bazzline\MediaLibrary\Model\Database\User\IdentityQuery');
    }
