...
use Net\Bazzline\MediaLibrary\Model\Database\Media\DistributorQuery;
use Net\Bazzline\MediaLibrary\Model\Database\Media\Edition;
use Net\Bazzline\MediaLibrary\Model\Database\Media\EditionQuery;
...
use Net\Bazzline\MediaLibrary\Model\Database\Media\MediaToArtistQuery;
...
use Net\Bazzline\MediaLibrary\Model\Database\Media\TypeQuery;
...
abstract class BaseMedia extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\MediaPeer';
    ...
    public function setAudios(PropelCollection $audios, PropelPDO $con = null)
    {
        ...
        $this->audiosScheduledForDeletion = unserialize(serialize($audiosToDelete));
    ...
    public function setVideos(PropelCollection $videos, PropelPDO $con = null)
    {
        ...
        $this->videosScheduledForDeletion = unserialize(serialize($videosToDelete));
     ...
     * @return PropelObjectCollection|Game[] List of Game objects
     */
    public function getGamesJoinGamePlattform($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = GameQuery::create(null, $criteria);
        $query->joinWith('GamePlattform', $join_behavior);
    ...
    public function setMediaToArtists(PropelCollection $mediaToArtists, PropelPDO $con = null)
    {
        ...
        $this->mediaToArtistsScheduledForDeletion = unserialize(serialize($mediaToArtistsToDelete));
    ...
    public function setMediaToGenres(PropelCollection $mediaToGenres, PropelPDO $con = null)
    {
        ...
        $this->mediaToGenresScheduledForDeletion = unserialize(serialize($mediaToGenresToDelete));
    ...
    public function setMediaToLanguages(PropelCollection $mediaToLanguages, PropelPDO $con = null)
    {
        ...
        $this->mediaToLanguagesScheduledForDeletion = unserialize(serialize($mediaToLanguagesToDelete));
