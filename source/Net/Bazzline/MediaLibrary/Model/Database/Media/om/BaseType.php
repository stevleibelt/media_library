...
/**
 * Base class that represents a row from the 'net_bazzline_media_library_media_type' table.
 *
 *
 *
...
abstract class BaseType extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\TypePeer';
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO net_bazzline_media_library_media_type (%s) VALUES (%s)',
