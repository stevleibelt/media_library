...
/**
 * Base class that represents a row from the 'net_bazzline_media_library_media_audio_track' table.
 *
 *
 *
...
abstract class BaseTrack extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\Audio\\TrackPeer';
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->number_of_play = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->number_of_disc = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO net_bazzline_media_library_media_audio_track (%s) VALUES (%s)',
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[3] => $this->getNumberOfPlay(),
            $keys[4] => $this->getNumberOfDisc(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setNumberOfPlay($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setNumberOfDisc($arr[$keys[4]]);
