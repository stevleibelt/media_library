...
/**
 * Base class that represents a row from the 'net_bazzline_media_library_media_comment' table.
 *
 *
 *
...
abstract class BaseComment extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\CommentPeer';
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO net_bazzline_media_library_media_comment (%s) VALUES (%s)',
