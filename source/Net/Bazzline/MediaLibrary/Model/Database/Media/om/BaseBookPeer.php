...
use Net\Bazzline\MediaLibrary\Model\Database\Media\map\BookTableMap;

/**
 * Base static class for performing query and update operations on the 'net_bazzline_media_library_media_book' table.
 *
 *
 *
...
abstract class BaseBookPeer
{
    ...
    const TABLE_NAME = 'net_bazzline_media_library_media_book';

    /** the related Propel class for this table */
    const OM_CLASS = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\Book';
    ...
    const ID = 'net_bazzline_media_library_media_book.id';

    /** the column name for the media_id field */
    const MEDIA_ID = 'net_bazzline_media_library_media_book.media_id';

    /** the column name for the number_of_pages field */
    const NUMBER_OF_PAGES = 'net_bazzline_media_library_media_book.number_of_pages';

    /** the column name for the isbn_10 field */
    const ISBN_10 = 'net_bazzline_media_library_media_book.isbn_10';

    /** the column name for the isbn_13 field */
    const ISBN_13 = 'net_bazzline_media_library_media_book.isbn_13';
    ...
    /**
     * Method to invalidate the instance pool of all tables related to net_bazzline_media_library_media_book
    ...
    /**
     * Deletes all rows from the net_bazzline_media_library_media_book table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
