...
/**
 * Base class that represents a row from the 'net_bazzline_media_library_media_artists' table.
 *
 *
 *
...
abstract class BaseArtist extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\ArtistPeer';
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO net_bazzline_media_library_media_artists (%s) VALUES (%s)',
