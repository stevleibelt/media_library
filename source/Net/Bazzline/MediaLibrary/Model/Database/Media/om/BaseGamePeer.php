...
use Net\Bazzline\MediaLibrary\Model\Database\Media\map\GameTableMap;

/**
 * Base static class for performing query and update operations on the 'net_bazzline_media_library_media_game' table.
 *
 *
 *
...
abstract class BaseGamePeer
{
    ...
    const TABLE_NAME = 'net_bazzline_media_library_media_game';

    /** the related Propel class for this table */
    const OM_CLASS = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\Game';
    ...
    const ID = 'net_bazzline_media_library_media_game.id';

    /** the column name for the media_id field */
    const MEDIA_ID = 'net_bazzline_media_library_media_game.media_id';

    /** the column name for the game_plattform_id field */
    const GAME_PLATTFORM_ID = 'net_bazzline_media_library_media_game.game_plattform_id';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'MediaId', 'GamePlattformId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'mediaId', 'gamePlattformId', ),
        BasePeer::TYPE_COLNAME => array (GamePeer::ID, GamePeer::MEDIA_ID, GamePeer::GAME_PLATTFORM_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'MEDIA_ID', 'GAME_PLATTFORM_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'media_id', 'game_plattform_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'MediaId' => 1, 'GamePlattformId' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'mediaId' => 1, 'gamePlattformId' => 2, ),
        BasePeer::TYPE_COLNAME => array (GamePeer::ID => 0, GamePeer::MEDIA_ID => 1, GamePeer::GAME_PLATTFORM_ID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'MEDIA_ID' => 1, 'GAME_PLATTFORM_ID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'media_id' => 1, 'game_plattform_id' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GamePeer::GAME_PLATTFORM_ID);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.media_id');
            $criteria->addSelectColumn($alias . '.game_plattform_id');
        }
    }
    ...
    /**
     * Method to invalidate the instance pool of all tables related to net_bazzline_media_library_media_game
    ...
    /**
     * Returns the number of rows matching criteria, joining the related GamePlattform table
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
     * @param      PropelPDO $con
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinGamePlattform(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
        ...
        $criteria->addJoin(GamePeer::GAME_PLATTFORM_ID, GamePlattformPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Game objects pre-filled with their GamePlattform objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Game objects.
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinGamePlattform(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = GamePlattformPeer::getPrimaryKeyHashFromRow($row, $startcol);
            if ($key2 !== null) {
                $obj2 = GamePlattformPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                    ...
                    $obj2 = new $cls();
                    $obj2->hydrate($row, $startcol);
                    GamePlattformPeer::addInstanceToPool($obj2, $key2);
                } // if obj2 already loaded

                // Add the $obj1 (Game) to $obj2 (GamePlattform)
                $obj2->addGame($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        GamePlattformPeer::addSelectColumns($criteria);
        $startcol4 = $startcol3 + GamePlattformPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            // Add objects for joined GamePlattform rows

            $key3 = GamePlattformPeer::getPrimaryKeyHashFromRow($row, $startcol3);
            if ($key3 !== null) {
                $obj3 = GamePlattformPeer::getInstanceFromPool($key3);
                if (!$obj3) {
                    ...
                    GamePlattformPeer::addInstanceToPool($obj3, $key3);
                } // if obj3 loaded

                // Add the $obj1 (Game) to the collection in $obj3 (GamePlattform)
                $obj3->addGame($obj1);
            } // if joined row not null
     ...
     * @return int Number of matching rows.
     */
    public static function doCountJoinAllExceptGamePlattform(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        // we're going to modify criteria, so copy it first
        $criteria = clone $criteria;
    ...
    public static function doSelectJoinAllExceptMedia(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        GamePlattformPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + GamePlattformPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = GamePeer::getInstanceFromPool($key1))) {
                ...
                $key2 = GamePlattformPeer::getPrimaryKeyHashFromRow($row, $startcol2);
                if ($key2 !== null) {
                    $obj2 = GamePlattformPeer::getInstanceFromPool($key2);
                    if (!$obj2) {
                ...
                // Add the $obj1 (Game) to the collection in $obj2 (GamePlattform)
                $obj2->addGame($obj1);
    ...
    /**
     * Selects a collection of Game objects pre-filled with all related objects except GamePlattform.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     ...
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinAllExceptGamePlattform(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $criteria = clone $criteria;
    ...
    /**
     * Deletes all rows from the net_bazzline_media_library_media_game table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
