...
use Net\Bazzline\MediaLibrary\Model\Database\Media\map\ArtistTableMap;

/**
 * Base static class for performing query and update operations on the 'net_bazzline_media_library_media_artists' table.
 *
 *
 *
...
abstract class BaseArtistPeer
{
    ...
    const TABLE_NAME = 'net_bazzline_media_library_media_artists';

    /** the related Propel class for this table */
    const OM_CLASS = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\Artist';
    ...
    const ID = 'net_bazzline_media_library_media_artists.id';

    /** the column name for the name field */
    const NAME = 'net_bazzline_media_library_media_artists.name';
    ...
    /**
     * Method to invalidate the instance pool of all tables related to net_bazzline_media_library_media_artists
    ...
    /**
     * Deletes all rows from the net_bazzline_media_library_media_artists table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
