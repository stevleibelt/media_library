...
use Net\Bazzline\MediaLibrary\Model\Database\Media\map\VideoTableMap;

/**
 * Base static class for performing query and update operations on the 'net_bazzline_media_library_media_video' table.
 *
 *
 *
...
abstract class BaseVideoPeer
{
    ...
    const TABLE_NAME = 'net_bazzline_media_library_media_video';

    /** the related Propel class for this table */
    const OM_CLASS = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\Video';
    ...
    const ID = 'net_bazzline_media_library_media_video.id';

    /** the column name for the media_id field */
    const MEDIA_ID = 'net_bazzline_media_library_media_video.media_id';

    /** the column name for the duration field */
    const DURATION = 'net_bazzline_media_library_media_video.duration';

    /** the column name for the number_of_discs field */
    const NUMBER_OF_DISCS = 'net_bazzline_media_library_media_video.number_of_discs';
    ...
    /**
     * Method to invalidate the instance pool of all tables related to net_bazzline_media_library_media_video
    ...
    /**
     * Deletes all rows from the net_bazzline_media_library_media_video table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
