...
/**
 * Base class that represents a row from the 'net_bazzline_media_library_media_book' table.
 *
 *
 *
...
abstract class BaseBook extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\BookPeer';
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO net_bazzline_media_library_media_book (%s) VALUES (%s)',
