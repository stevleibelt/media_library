...
/**
 * Base class that represents a row from the 'net_bazzline_media_library_media_genre' table.
 *
 *
 *
...
abstract class BaseGenre extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\GenrePeer';
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO net_bazzline_media_library_media_genre (%s) VALUES (%s)',
