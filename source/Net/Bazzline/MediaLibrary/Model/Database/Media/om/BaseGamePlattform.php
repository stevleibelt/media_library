...
/**
 * Base class that represents a row from the 'net_bazzline_media_library_media_game_plattform' table.
 *
 *
 *
 ...
 */
abstract class BaseGamePlattform extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\GamePlattformPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        GamePlattformPeer
     */
     ...
     * @return GamePlattform The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = GamePlattformPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = GamePlattformPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = GamePlattformPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GamePlattform object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GamePlattformPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GamePlattformQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GamePlattformPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(GamePlattformPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(GamePlattformPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }

        $sql = sprintf(
            'INSERT INTO net_bazzline_media_library_media_game_plattform (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GamePlattformPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GamePlattformPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['GamePlattform'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['GamePlattform'][$this->getPrimaryKey()] = true;
        $keys = GamePlattformPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(GamePlattformPeer::ID)) $criteria->add(GamePlattformPeer::ID, $this->id);
        if ($this->isColumnModified(GamePlattformPeer::NAME)) $criteria->add(GamePlattformPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(GamePlattformPeer::DATABASE_NAME);
        $criteria->add(GamePlattformPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of GamePlattform (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GamePlattform Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GamePlattformPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GamePlattformPeer();
        }
     ...
     * If this GamePlattform is new, it will return
    ...
    public function setGames(PropelCollection $games, PropelPDO $con = null)
    {
        ...
        foreach ($gamesToDelete as $gameRemoved) {
            $gameRemoved->setGamePlattform(null);
        }
     ...
     * Otherwise if this GamePlattform is new, it will return
     * an empty collection; or if this GamePlattform has previously
     * been saved, it will retrieve related Games from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in GamePlattform.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(GamePlattformPeer::DEFAULT_STRING_FORMAT);
    }
