...
/**
 * Base class that represents a row from the 'net_bazzline_media_library_media_video' table.
 *
 *
 *
...
abstract class BaseVideo extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\VideoPeer';
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO net_bazzline_media_library_media_video (%s) VALUES (%s)',
