...
/**
 * Base class that represents a row from the 'net_bazzline_media_library_media_distributor' table.
 *
 *
 *
...
abstract class BaseDistributor extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\DistributorPeer';
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO net_bazzline_media_library_media_distributor (%s) VALUES (%s)',
