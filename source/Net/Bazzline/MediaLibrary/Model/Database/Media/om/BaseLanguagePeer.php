...
use Net\Bazzline\MediaLibrary\Model\Database\Media\map\LanguageTableMap;

/**
 * Base static class for performing query and update operations on the 'net_bazzline_media_library_media_language' table.
 *
 *
 *
...
abstract class BaseLanguagePeer
{
    ...
    const TABLE_NAME = 'net_bazzline_media_library_media_language';

    /** the related Propel class for this table */
    const OM_CLASS = 'Net\\Bazzline\\MediaLibrary\\Model\\Database\\Media\\Language';
    ...
    const ID = 'net_bazzline_media_library_media_language.id';

    /** the column name for the name field */
    const NAME = 'net_bazzline_media_library_media_language.name';

    /** the column name for the shortcut field */
    const SHORTCUT = 'net_bazzline_media_library_media_language.shortcut';
    ...
    /**
     * Method to invalidate the instance pool of all tables related to net_bazzline_media_library_media_language
    ...
    /**
     * Deletes all rows from the net_bazzline_media_library_media_language table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
