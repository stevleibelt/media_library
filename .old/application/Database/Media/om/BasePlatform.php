...
/**
 * Base class that represents a row from the 'net_bazzline_media_library_media_platform' table.
 *
 *
 *
...
abstract class BasePlatform extends BaseObject implements Persistent
{
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO net_bazzline_media_library_media_platform (%s) VALUES (%s)',
